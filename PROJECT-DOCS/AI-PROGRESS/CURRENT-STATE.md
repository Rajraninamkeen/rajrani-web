...
| Current session | Session 28 — OPERATOR Operations console (order fulfilment + returns queues) in the catalog console + small staff read endpoints (`/api/v1/ops/*`), done |
